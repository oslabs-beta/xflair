...
export default function Home() {
  ...
  function logs(data: string) {
    fetch('http://localhost:5000/logs/MobileNet', {
      method: 'POST',
      headers: {
  ...
  function predict(data: string) {
    fetch('http://localhost:5000/predictions/MobileNet', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  function heatmaps(data: string) {
    fetch('http://localhost:5000/heatmaps/MobileNet', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  function featureMaps(data: string) {
    fetch('http://localhost:5000/featuremaps/MobileNet', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
