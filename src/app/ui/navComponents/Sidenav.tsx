...
export default function Sidenav({ sidebarOpen, setSidebarOpen }: props) {
  ...
  return (
    <div
      ...
      } transition-transform duration-300 flex flex-col items-center bg-black border-r-2 border-gray-900`}
    >
      <div className='flex justify-start w-64 px-6 pt-5'>
        <p
      ...
      <div className='w-full flex justify-center items-center bg-transparent pt-5 pb-5 short:hidden'>
        <img
