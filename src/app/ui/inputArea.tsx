...
export default function InputArea() {
  ...
  return (
    <div className={styles.inputBox}>
      ...
      {imgURL && (
        <img className={styles.uploadImg} src={imgURL} alt='UploadedImage' />
      )}
      {vizState && (
        <>
      ...
      {!imgURL && <p className={styles.placeholderText}>Waiting for image</p>}
      ...
      <div className={styles.buttonBox}>
        ...
        <button className={styles.primaryBtn} id='upload' onClick={uploadClick}>
          Upload
        </button>
